 ...
 *
 * 类描述：短信发送接口调用类
 * 类名称：com.uflowertv.util.MessageUtil     
 * 创建人：liguoliang 
 * 创建时间：2017年2月23日 下午5:12:00   
 * 修改人：
 * 修改时间：2017年2月23日 下午5:12:00   
 * 修改备注：   
 * @version   V1.0
 */
...
*/       
	   String result = MessageUtil.transmessage(ConstantHolder.SMSURL, MessageUtil.getMsgJson("18201508823", "1234"));
    ...
    * @return
    */
   public static String getMsgJson(String phone,String content){
	   JSONObject jsonObj = new JSONObject();
       jsonObj.put("op", "Sms.send");
       jsonObj.put("apiKey", ConstantHolder.APIKEY);
       jsonObj.put("ts", System.currentTimeMillis());
