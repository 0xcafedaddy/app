...
/**
 * <p>goodsInfo complex type的 Java 类。
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="goodsList" type="{http://impl.webservice.server.ectchannel.ccn.crunii.com/}goods" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "goodsInfo", propOrder = {
    "goodsList"
})
