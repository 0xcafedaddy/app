 ...
 * @version   V1.0
 */
public class NotifyUrlThread implements Runnable {
	private static Logger log = LoggerFactory.getLogger(NotifyUrlThread.class);
	
	private long sleeptime;
	
    public NotifyUrlThread(long sleeptime) {
    	this.sleeptime = sleeptime;
    }
    
	private void cloudComposeTask() {
		System.out.println("NotifyUrlThread.cloudComposeTask()");
	}
