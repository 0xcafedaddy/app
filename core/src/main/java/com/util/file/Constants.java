...
import com.util.context.AppPath;
...
public class Constants {
	...
	public static final String BASE_ACCESS_PATH= ConstantConfig.getProperty("BASE_ACCESS_PATH");
	...
	public static final String IMG_WEB=ConstantConfig.getProperty("IMG_WEB");    //测试环境
