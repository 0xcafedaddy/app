...
/**
 * <p>balanceInfo complex type的 Java 类。
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="balanceList" type="{http://impl.webservice.server.ectchannel.ccn.crunii.com/}balance" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    extends ReturnData
{
    ...
    protected List<Balance> balanceList;
