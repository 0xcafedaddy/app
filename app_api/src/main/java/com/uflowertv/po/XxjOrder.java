...
public class XxjOrder implements Serializable{
	...
	public XxjOrder(Integer user_id, String oper_offerId) {
		super();
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((oper_orderId == null) ? 0 : oper_orderId.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (oper_orderId == null) {
			if (other.oper_orderId != null)
				return false;
		} else if (!oper_orderId.equals(other.oper_orderId))
			return false;
		if (user_id == null) {
