...
public class BossServiceImpl implements BossServiceI{
	...
	/**
	 * 套餐校验
	 * @see BossServiceI#intfComboValid(String, String, String)
	 */
	@Override
	...
	/**
	 * 家长锁(只提供查询)
	 * @see BossServiceI#intfParentLocker(String, String, String, String, String)
	 */
	@Override
	...
	/**
	 * 套餐订购
	 * @see BossServiceI#intfComboOrder(String, String, String, String)
	 */
	@Override
