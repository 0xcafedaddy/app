...
public class UserResource {
	...
	public Map<String, Object> production_list(@PathParam(value = "platformId") int platformId,
								  			   @PathParam(value = "userId") int userId) {
	 ...
	 * @
	 */
	@Path("purchase/info/{card}/{orderId}")
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	public Map<String, Object> purchase(@PathParam(value = "card") String card,
							 			@PathParam(value = "orderId") String orderId) {
		return xxjOrderService.saveObj(card,orderId);
	}
