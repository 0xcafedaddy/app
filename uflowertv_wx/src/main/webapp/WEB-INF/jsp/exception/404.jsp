		...
		<!-- Not found text -->
			...
			<!-- dog bubble talking -->
			    ...
			    <div class="bubble-options">
			        ...
			        <p class="dog-bubble" style="opacity: 1; bottom: 10px;">
			        	I wish I had a cookie<br><img style="margin-top:8px" src="<%=path%>/static/images/404/cookie.png" alt="cookie">
			        </p>
			        <p class="dog-bubble" style="opacity: 1; bottom: 10px;">
			        	<br>
			        ...
			        <p class="dog-bubble" style="opacity: 1; bottom: 10px;">
			        	I think I saw a <br><img style="margin-top:8px" src="<%=path%>/static/images/404/cat.png" alt="cat">
			        </p>
			        <p class="dog-bubble" style="opacity: 1; bottom: 10px;">
