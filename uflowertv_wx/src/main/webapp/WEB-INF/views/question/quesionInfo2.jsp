		...
		<form id="editForm" method="post" >	
			<table align="center" cellpadding="0" cellspacing="10">
				...
				<tr>
					...
					<td>
						<input type="text" disabled="disabled" value="${question.wxUserQuestionType}"/>
					</td>
				</tr>	
				<tr>
					<td align="right">问题描述:</td>
					<td>
						<textarea rows="7" cols="80" disabled="disabled">${question.wxUserQuestionContent}</textarea>
					</td>
				</tr>	
				<tr>
					<td align="right">客服回复:</td>
					<td>
						<textarea rows="7" cols="80" id="replyQuestion" readonly="readonly">${question.replyQuestionContent}</textarea>
						<br/>
