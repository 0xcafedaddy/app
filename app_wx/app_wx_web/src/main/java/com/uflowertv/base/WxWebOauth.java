...
import com.uflowertv.model.dto.Follower;
import com.uflowertv.model.dto.OauthAccessToken;
...
public class WxWebOauth {
     ...
     */
    public static Follower getUserInfo(String appid, String secret, String code){
